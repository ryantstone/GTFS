...
public struct Frequencies: Equatable, Codable, Hashable {
    ...
    public enum TripType: Int, Equatable, Hashable {
...
extension Frequencies {
    public init(from decoder: Decoder) throws {
        ...
        self.headwaySeconds = try container.decode(Double.self, forKey: .endTime)
        self.exactTimes = try? container.decode(Int.self, forKey: .exactTimes)
    }
}
